...
_alpinejs["default"].plugin(_intersect["default"]);
//Init persist plugin
_alpinejs["default"].plugin(_persist["default"]);
//Init store
_alpinejs["default"].store("app", {
  isSiderbarOpen: _alpinejs["default"].$persist(false)
});
//Start Alpine JS
...
document.onreadystatechange = function () {
  if (document.readyState == "complete") {
    //Switch backgrounds
    var changeBackgrounds = (0, _utils.insertBgImages)();
...
},{"./libs/components":6,"./libs/components/pageloader/pageloader":8,"./libs/utils/utils":10,"@alpinejs/intersect":1,"@alpinejs/persist":2,"alpinejs":3,"feather-icons":4}]},{},[11]);
